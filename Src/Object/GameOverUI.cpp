...
// ============================================================
void GameOverUI::StartTypewriter(const std::string& text)
{
    fullText_ = text;
    shownText_ = "";
    typeTimer_ = 0;
...
void GameOverUI::UpdateTypewriter()
{
...
// ============================================================
void GameOverUI::DrawCharacter() const
{
...
// ============================================================
void GameOverUI::DrawChatWindow() const
{
